...
int main() {
    ...
    Matrix<float> test3(2, 2); 

    try {
        std::cout << "Tentative de calcul..." << std::endl;
        test3 = test * test2;
        
        // Ce qui suit ne s'affichera que si le calcul réussit
        std::cout << "Calcul reussi !" << std::endl;
        test3.print(); 
    } 
    catch (const std::exception& e) {
        // Ce qui suit s'affichera en cas d'erreur
        std::cerr << "Capture de l'exception : " << e.what() << std::endl;
    }
